...
optimization <- function(brand,shiny_const,budget_const,all_other_sales,opti_goal,opti_sign,events_base,ppg_slots,exclude_ppg,
  ...
  best_roi_flyer = events_base[events_base$key %in% best_roi_display$key,]   #to extract all columns
  ...
  best_roi_display_flyer = events_base[events_base$key %in% best_roi_display$key,]   #to extract all columns
